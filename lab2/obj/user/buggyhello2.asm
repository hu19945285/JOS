...
sys_env_destroy(envid_t envid)
{
  ...
  800123:	00 
  800124:	c7 44 24 08 60 0f 80 	movl   $0x800f60,0x8(%esp)
  80012b:	00 
  80012c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800133:	00 
  800134:	c7 04 24 7d 0f 80 00 	movl   $0x800f7d,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80016f:	8d 5d 14             	lea    0x14(%ebp),%ebx
	...
	if (argv0)
  800172:	a1 0c 20 80 00       	mov    0x80200c,%eax
  800177:	85 c0                	test   %eax,%eax
  800179:	74 10                	je     80018b <_panic+0x24>
		cprintf("%s: ", argv0);
  80017b:	89 44 24 04          	mov    %eax,0x4(%esp)
  80017f:	c7 04 24 8b 0f 80 00 	movl   $0x800f8b,(%esp)
  800186:	e8 ee 00 00 00       	call   800279 <cprintf>
	cprintf("[%08x] user panic in %s at %s:%d: ",
  80018b:	8b 35 04 20 80 00    	mov    0x802004,%esi
  800191:	e8 b2 ff ff ff       	call   800148 <sys_getenvid>
  ...
  8001ac:	c7 04 24 90 0f 80 00 	movl   $0x800f90,(%esp)
  8001b3:	e8 c1 00 00 00       	call   800279 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8001b8:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8001bc:	8b 45 10             	mov    0x10(%ebp),%eax
  8001bf:	89 04 24             	mov    %eax,(%esp)
  8001c2:	e8 51 00 00 00       	call   800218 <vcprintf>
	cprintf("\n");
  8001c7:	c7 04 24 54 0f 80 00 	movl   $0x800f54,(%esp)
  8001ce:	e8 a6 00 00 00       	call   800279 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8001d3:	cc                   	int3   
  8001d4:	eb fd                	jmp    8001d3 <_panic+0x6c>
...
putch(int ch, struct printbuf *b)
{
  ...
  8001f3:	75 19                	jne    80020e <putch+0x38>
		sys_cputs(b->buf, b->idx);
  8001f5:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  8001fc:	00 
  8001fd:	8d 43 08             	lea    0x8(%ebx),%eax
  800200:	89 04 24             	mov    %eax,(%esp)
  800203:	e8 b1 fe ff ff       	call   8000b9 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80024d:	c7 04 24 d6 01 80 00 	movl   $0x8001d6,(%esp)
  800254:	e8 bb 01 00 00       	call   800414 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  80026c:	e8 48 fe ff ff       	call   8000b9 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80037e:	0f be 80 b4 0f 80 00 	movsbl 0x800fb4(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80049c:	ff 24 85 44 10 80 00 	jmp    *0x801044(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  80057e:	c7 44 24 08 d5 0f 80 	movl   $0x800fd5,0x8(%esp)
  800585:	00 
  ...
  8005ad:	ba c5 0f 80 00       	mov    $0x800fc5,%edx
