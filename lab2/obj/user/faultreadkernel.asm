	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80025e:	0f be 80 79 0f 80 00 	movsbl 0x800f79(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80037c:	ff 24 85 08 10 80 00 	jmp    *0x801008(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  80045e:	c7 44 24 08 9a 0f 80 	movl   $0x800f9a,0x8(%esp)
  800465:	00 
  ...
  80048d:	ba 8a 0f 80 00       	mov    $0x800f8a,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800c06:	00 
  800c07:	c7 44 24 08 7c 11 80 	movl   $0x80117c,0x8(%esp)
  800c0e:	00 
  800c0f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c16:	00 
  800c17:	c7 04 24 99 11 80 00 	movl   $0x801199,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c62:	c7 04 24 a7 11 80 00 	movl   $0x8011a7,(%esp)
  ...
  800c8f:	c7 04 24 b0 11 80 00 	movl   $0x8011b0,(%esp)
  ...
  800ca5:	e8 51 f4 ff ff       	call   8000fb <vcprintf>
	cprintf("\n");
  800caa:	c7 04 24 ac 11 80 00 	movl   $0x8011ac,(%esp)
