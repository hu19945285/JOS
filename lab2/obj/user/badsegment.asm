...
sys_env_destroy(envid_t envid)
{
  ...
  800111:	00 
  800112:	c7 44 24 08 42 0f 80 	movl   $0x800f42,0x8(%esp)
  800119:	00 
  80011a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800121:	00 
  800122:	c7 04 24 5f 0f 80 00 	movl   $0x800f5f,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80015d:	8d 5d 14             	lea    0x14(%ebp),%ebx
	...
	if (argv0)
  800160:	a1 08 20 80 00       	mov    0x802008,%eax
  800165:	85 c0                	test   %eax,%eax
  800167:	74 10                	je     800179 <_panic+0x24>
		cprintf("%s: ", argv0);
  800169:	89 44 24 04          	mov    %eax,0x4(%esp)
  80016d:	c7 04 24 6d 0f 80 00 	movl   $0x800f6d,(%esp)
  800174:	e8 ee 00 00 00       	call   800267 <cprintf>
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800179:	8b 35 00 20 80 00    	mov    0x802000,%esi
  80017f:	e8 b2 ff ff ff       	call   800136 <sys_getenvid>
  ...
  80019a:	c7 04 24 74 0f 80 00 	movl   $0x800f74,(%esp)
  ...
  8001b0:	e8 51 00 00 00       	call   800206 <vcprintf>
	cprintf("\n");
  8001b5:	c7 04 24 72 0f 80 00 	movl   $0x800f72,(%esp)
  8001bc:	e8 a6 00 00 00       	call   800267 <cprintf>
	...
	while (1)
		asm volatile("int3");
  8001c1:	cc                   	int3   
  8001c2:	eb fd                	jmp    8001c1 <_panic+0x6c>
...
putch(int ch, struct printbuf *b)
{
  ...
  8001f1:	e8 b1 fe ff ff       	call   8000a7 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800242:	e8 bd 01 00 00       	call   800404 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  80025a:	e8 48 fe ff ff       	call   8000a7 <sys_cputs>
