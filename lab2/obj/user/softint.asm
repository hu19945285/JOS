...
sys_env_destroy(envid_t envid)
{
  ...
  80010d:	00 
  80010e:	c7 44 24 08 32 0f 80 	movl   $0x800f32,0x8(%esp)
  800115:	00 
  800116:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80011d:	00 
  80011e:	c7 04 24 4f 0f 80 00 	movl   $0x800f4f,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800159:	8d 5d 14             	lea    0x14(%ebp),%ebx
	...
	if (argv0)
  80015c:	a1 08 20 80 00       	mov    0x802008,%eax
  800161:	85 c0                	test   %eax,%eax
  800163:	74 10                	je     800175 <_panic+0x24>
		cprintf("%s: ", argv0);
  800165:	89 44 24 04          	mov    %eax,0x4(%esp)
  800169:	c7 04 24 5d 0f 80 00 	movl   $0x800f5d,(%esp)
  800170:	e8 ee 00 00 00       	call   800263 <cprintf>
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800175:	8b 35 00 20 80 00    	mov    0x802000,%esi
  80017b:	e8 b2 ff ff ff       	call   800132 <sys_getenvid>
  800180:	8b 55 0c             	mov    0xc(%ebp),%edx
  800183:	89 54 24 10          	mov    %edx,0x10(%esp)
  800187:	8b 55 08             	mov    0x8(%ebp),%edx
  80018a:	89 54 24 0c          	mov    %edx,0xc(%esp)
  80018e:	89 74 24 08          	mov    %esi,0x8(%esp)
  800192:	89 44 24 04          	mov    %eax,0x4(%esp)
  800196:	c7 04 24 64 0f 80 00 	movl   $0x800f64,(%esp)
  80019d:	e8 c1 00 00 00       	call   800263 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8001a2:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8001a6:	8b 45 10             	mov    0x10(%ebp),%eax
  8001a9:	89 04 24             	mov    %eax,(%esp)
  8001ac:	e8 51 00 00 00       	call   800202 <vcprintf>
	cprintf("\n");
  8001b1:	c7 04 24 62 0f 80 00 	movl   $0x800f62,(%esp)
  8001b8:	e8 a6 00 00 00       	call   800263 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8001bd:	cc                   	int3   
  8001be:	eb fd                	jmp    8001bd <_panic+0x6c>
...
putch(int ch, struct printbuf *b)
{
  ...
  8001c7:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	b->buf[b->idx++] = ch;
  8001ca:	8b 13                	mov    (%ebx),%edx
  8001cc:	8d 42 01             	lea    0x1(%edx),%eax
  8001cf:	89 03                	mov    %eax,(%ebx)
  8001d1:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8001d4:	88 4c 13 08          	mov    %cl,0x8(%ebx,%edx,1)
	if (b->idx == 256-1) {
  ...
  8001ed:	e8 b1 fe ff ff       	call   8000a3 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80023e:	e8 b1 01 00 00       	call   8003f4 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800256:	e8 48 fe ff ff       	call   8000a3 <sys_cputs>
