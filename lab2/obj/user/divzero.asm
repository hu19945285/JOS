...
umain(int argc, char **argv)
{
  ...
  800054:	c7 04 24 58 0f 80 00 	movl   $0x800f58,(%esp)
...
libmain(int argc, char **argv)
{
  ...
  80007a:	e8 bc 0b 00 00       	call   800c3b <sys_getenvid>
...
exit(void)
{
  ...
  8000c4:	e8 20 0b 00 00       	call   800be9 <sys_env_destroy>
}
  8000c9:	c9                   	leave  
  8000ca:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000f8:	e8 af 0a 00 00       	call   800bac <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800149:	e8 b6 01 00 00       	call   800304 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800161:	e8 46 0a 00 00       	call   800bac <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80026e:	0f be 80 70 0f 80 00 	movsbl 0x800f70(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80038c:	ff 24 85 00 10 80 00 	jmp    *0x801000(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  80046e:	c7 44 24 08 91 0f 80 	movl   $0x800f91,0x8(%esp)
  800475:	00 
  ...
  80049d:	ba 81 0f 80 00       	mov    $0x800f81,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800c16:	00 
  800c17:	c7 44 24 08 74 11 80 	movl   $0x801174,0x8(%esp)
  800c1e:	00 
  800c1f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c26:	00 
  800c27:	c7 04 24 91 11 80 00 	movl   $0x801191,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c62:	8d 5d 14             	lea    0x14(%ebp),%ebx
	...
	if (argv0)
  800c65:	a1 0c 20 80 00       	mov    0x80200c,%eax
  800c6a:	85 c0                	test   %eax,%eax
  800c6c:	74 10                	je     800c7e <_panic+0x24>
		cprintf("%s: ", argv0);
  800c6e:	89 44 24 04          	mov    %eax,0x4(%esp)
  800c72:	c7 04 24 9f 11 80 00 	movl   $0x80119f,(%esp)
  800c79:	e8 f0 f4 ff ff       	call   80016e <cprintf>
  ...
  800c9f:	c7 04 24 a4 11 80 00 	movl   $0x8011a4,(%esp)
  800ca6:	e8 c3 f4 ff ff       	call   80016e <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800cab:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800caf:	8b 45 10             	mov    0x10(%ebp),%eax
  800cb2:	89 04 24             	mov    %eax,(%esp)
  800cb5:	e8 53 f4 ff ff       	call   80010d <vcprintf>
	cprintf("\n");
  800cba:	c7 04 24 64 0f 80 00 	movl   $0x800f64,(%esp)
  800cc1:	e8 a8 f4 ff ff       	call   80016e <cprintf>
